...
#                TCM3001_ID = config.get('CEMS', 'TCM3001_ID')
               print getMAC(interface='wlan0')
                ...
                print '[ID=172]'
                TCM3003_ID = 172
                Meter_Value = master.execute(172, cst.READ_INPUT_REGISTERS, 61792, 64)
                print  Meter_Value
                CEMS_Input(TCM3003_ID, Meter_Value)
                time.sleep(1)

                print '[ID=173]'
                TCM3003_ID = 173
                Meter_Value = master.execute(173, cst.READ_INPUT_REGISTERS, 61792, 64)
                print Meter_Value
                CEMS_Input(TCM3003_ID, Meter_Value)
                time.sleep(1)
...
def CEMS_Input(Meter_Value):
    ...
    API_ENDPOINT = CEMS_URL + "input/post.json?node=" + NODE_NAME + "_" + TCM3003_ID + "&json={"\
